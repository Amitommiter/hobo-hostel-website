...
export default function DoubleRoomPage() {
  ...
  const roomTypes = [
    {
      ...
      description: "Luxury accommodation with premium amenities and stunning mountain views",
      price: "₹",
      features: ["Premium bedding", "Mountain view balcony", "Private entrance", "En-suite bathroom"],
      gradient: "from-purple-500 to-pink-500",
      link: "/forms/checkin"
    },
    {
      title: "Normal Double Room",
      description: "Comfortable accommodation with all essential amenities",
      price: "₹",
      features: ["Comfortable bedding", "Shared bathroom", "Window view", "Essential amenities"],
  ...
  const amenities = [
    ...
    "Reading lights and charging points",
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed mb-8">
              Your own sanctuary with stunning mountain views and complete privacy. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Select the perfect double room option for your stay
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Double Room <span className="text-pink-600">Gallery</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Take a look at our comfortable and luxurious double room spaces
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500 to-rose-500 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Book Your Double Room?
          </h2>
          <p className="text-xl mb-8 text-pink-100">
            Experience comfort and privacy in the heart of the Himalayas
          </p>
          <Button 
            size="lg" 
            variant="secondary"
